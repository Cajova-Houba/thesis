...
- pro objektové jazyky se hodí object kalkul od Abadi a Cardelliho
- typově silný jazyk = žádné execution errors pro jakýkoliv program napsaný v daném jazyce \cite{cardelli2004}
- 
...
- rekurzivní datový typ, je takový, který ve své definici používá sám sebe (například typ proměnné, nebo argumentu funkce)
...
- zmínit self tady
	- late binding of self \cite{pierce2002}
	- použito v object calculu pro definici rekurzivních typů (resp. jejich protokolů)
- zmínit super, kterým se objekty mohou odkazovat na rodiče
- možná fajn na rekurzivní typy: http://web.mit.edu/6.005/www/sp16/classes/16-recursive-data-types/recursive/

- pro popis rekurzivních typů 
...
- k typové kontrole lze použít dvou relací: matching a subtyping
