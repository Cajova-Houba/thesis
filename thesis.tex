...
\addcontentsline{toc}{chapter}{Příloha B - Výčet metadat služeb získaných z implementace}
\begin{table}[h]
	\centering
	\begin{tabular}{|l|c|c|}
		\hline
...
\addcontentsline{toc}{chapter}{Příloha C - Výčet metadat služeb získaných z popisu}
...
\chapter*{Příloha D - Popisy rozhraní testovaných služeb}
\addcontentsline{toc}{chapter}{Příloha D - Popisy rozhraní testovaných služeb}
