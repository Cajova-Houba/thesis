...
Modul pro indexování REST API vznikl v rámci diplomové práce slečny Bc. Hessové. Princip sběru dat je založen na binární analýze java byte kódu implementace serveru s webovou službou a následné rekonstrukce rozhraní služby vyhledáním patternů odpovídajícím podporovaným frameworkům pro tvorbu REST API. Těmi jsou Jersey verze 2.26, RESTEasy verze 3.0.16 a Spring Web MVC založený na Spring Boot verze 1.5.9 \cite{hessova2015rest}.
