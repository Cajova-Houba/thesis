...
\section{Datové typy a jejich reprezentace}
 ...
 - Datový typ představuje množinu hodnot, ze které může proměnná, konstanta, funkce, nebo jiný výraz vzít svou hodnotu \cite{dataType}
...
\subsection{Záznamy}
 ...
 - v C např \textit{struct}, v Pascalu \textit{record}, v Jave není

\subsection{Objektové datové typy}

 - datový typ složený s dat a metod
...
- The fundamental purpose of a type system is to prevent the occurrence of execution errors during the running of a program. \cite{cardelli2004}
- typový systém  udává pravidla pro kontrolu typů v programovacím jazyce nezávisle na konkrétních algoritmech \cite{cardelli2004}
